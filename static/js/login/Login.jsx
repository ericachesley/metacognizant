                ...
                <section className='container-fluid' id='about-holder'>
                    ...
                    <div className='row align-items-start static-height'>
                        <div id='about1' className=" about col-5 col-xs-6 col-sm-6 col-md-11 col-lg-11">
                            <p><img className='studentview shadow' src='/static/images/StudentView.png' />
                                <br></br>Through daily reflections, students develop
                                ...
                                <br></br><br></br>
                                Google Classroom integration streamlines setup
                                and keeps student assignments in one place.
                                </p>
                    ...
                    <div className='row align-items-start static-height'>
                        <div id='about2' className="about col-5 col-xs-6 col-sm-6 col-md-11 col-lg-11">
                            <p><img className='teacherview shadow' src='/static/images/TeacherView.png' />
                                <br></br>Teachers easily select from a bank of 
                                ...
                                <br></br><br></br>
                                Natural language processing evaluates response 
                                sentiment and displays it visually for quick perusal.
                                </p>
